...
void test_detector(network net,char *filename, float thresh, float hier_thresh, char *outfile)
{
    ...
    float nms=.3;
        ...
        */
        ...
        //scanf("%s",input);
        ////
        image im = load_image_color(filename,0,0);///////////读入图片
        image sized = letterbox_image(im, net.w, net.h);

        layer l = net.layers[net.n-1];////??????
        //printf("l.w=%d,l.h=%d,l.n=%d\n",l.w,l.h,l.n);
        box *boxes = calloc(l.w*l.h*l.n, sizeof(box));//分配内存空间
        float **probs = calloc(l.w*l.h*l.n, sizeof(float *));//
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        draw_detections(im, l.w*l.h*l.n, thresh, boxes, probs, masks, names, alphabet, l.classes);/////计算概率，输出画图
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{   gpu_index=0;
    ...
    network net = parse_network_cfg(cfg);////////////从配置文件读取网络结构
    if(weights){
        load_weights(&net, weights);////////////加载权重
    }
